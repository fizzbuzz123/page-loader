...
const expectedImgFilePath = makeFixturePath('expected/my-site-index_files', 'assets-images-cat.jpg');
const replyImgFilePath = makeFixturePath('replies/assets/images/cat.jpg');
